...
namespace Apt.Nop.Plugin.Misc.TopicsPlus.Infrastructure
{
    ...
    public class PluginViewLocationExpander : IViewLocationExpander
    {
            ...
            IEnumerable<string> viewLocations)
        {
            ...
            {
                pluginLocations.Add($"/Themes/{theme}{TopicsPlusConstants.PathToPlugin}/Views/{{1}}/{{0}}.cshtml");
                pluginLocations.Add($"/Themes/{theme}{TopicsPlusConstants.PathToPlugin}/Views/Shared/{{0}}.cshtml");
            }

            pluginLocations.Add($"{TopicsPlusConstants.PathToPlugin}/Views/{{1}}/{{0}}.cshtml");
            pluginLocations.Add($"{TopicsPlusConstants.PathToPlugin}/Views/Shared/{{0}}.cshtml");
